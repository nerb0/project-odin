...
function App() {
	...
	return (
		<div className="bg-gray-700">
			<div className="px-64 text-slate-800 h-screen min-h-[900px] min-w-screen flex">
				<div className="bg-slate-600 p-2 flex flex-col flex-1">
					<h1 className="text-center font-extrabold text-4xl mb-4 text-white">
						Mini Message Board
					</h1>
					...
					{!loading && !error && data && (
						<Fragment>
							<div className="flex flex-col flex-1 overflow-scroll gap-y-2 [scrollbar-color:white_transparent]" ref={messagesRef}>
								{data.map((board, i) => (
									<div
							...
							<form
								...
								<div className="flex flex-col flex-1">
									<input
										className="rounded-tl-md px-2 py-1 bg-slate-700 focus:z-50"
									...
									/>
									<input
										className="rounded-bl-md px-2 py-1 bg-slate-700 focus:z-50"
										placeholder="Message"
										maxLength={250}
										type="text"
										name="message"
								...
								<button className="px-14 py-1 bg-slate-800 text-white text-xl font-bold rounded-r-md">
									Send
								</button>
							</form>
						</Fragment>
