...
console.log(linkedList.pop()); // Node { value: 'test3', nextNode: null }
console.log(linkedList.toString()); // null
...
linkedList.insertAt("test5",8); // Index out of bounds
console.log(linkedList.toString()); // (test3) -> (test1) -> (test4) -> (test2) -> null
linkedList.removeAt(2);
console.log(linkedList.toString()); // (test3) -> (test1) -> (test4) -> null
