export default `<div class="rounded-md p-4 bg-sky-300 w-full lg:w-[800px] shadow-md flex flex-col gap-10">
	<div class="flex gap-x-2 text-cyan-950 [&_*]:animate-pulse">
		<div class="h-fit w-fit">
			<div class="h-32 w-32 rounded-md bg-sky-500"></div>
		</div>
		<div class="relative flex-1 flex flex-col gap-y-2">
			<div class="h-10 w-60 rounded-md bg-sky-400"></div>
			<div class="h-20 w-48 rounded-md bg-sky-500"></div>
		</div>
		<div class="flex flex-col items-end gap-y-2">
			<div class="h-9 w-24 rounded-md bg-sky-400"></div>
			<div class="h-8 w-16 rounded-md bg-sky-400"></div>
		</div>
	</div>
