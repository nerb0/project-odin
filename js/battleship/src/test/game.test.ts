...
describe("valid", () => {
	const player1 = new Player("Player 1", [5, 4, 3, 3, 2]);
	const player2 = new Player("Player 2", [5, 4, 3, 3, 2]);

	player1.board.placeShip(player1.ships[0], 0, 5);
	player1.board.placeShip(player1.ships[1], 1, 0, "vertical");
	player1.board.placeShip(player1.ships[2], 0, 2, "vertical");
	player1.board.placeShip(player1.ships[3], 7, 0);
	player1.board.placeShip(player1.ships[4], 5, 4, "vertical");

	player2.board.placeShip(player2.ships[0], 2, 1);
	player2.board.placeShip(player2.ships[1], 0, 0, "vertical");
	player2.board.placeShip(player2.ships[2], 1, 0, "vertical");
	player2.board.placeShip(player2.ships[3], 7, 0);
	player2.board.placeShip(player2.ships[4], 5, 4, "vertical");
...
describe("should throw error", () => {
	const player1 = new Player("Player", [5, 4, 3, 3, 2]);
	player1.board.placeShip(player1.ships[0], 0, 5);
	player1.board.placeShip(player1.ships[1], 1, 0, "vertical");
	player1.board.placeShip(player1.ships[2], 0, 2, "vertical");
	...
	test("ship out of bounds", () => {
		...
		expect(() =>
			player1.board.placeShip(player1.ships[4], 0, -1, "vertical")
		).toThrowError("Ship is out of bounds");
		expect(() =>
			player1.board.placeShip(player1.ships[4], 0, 10, "vertical")
		).toThrowError("Ship is out of bounds");
		expect(() =>
			player1.board.placeShip(player1.ships[4], 4, 9, "vertical")
		).toThrowError("Ship is out of bounds");
		expect(() => player1.board.placeShip(player1.ships[4], 9, 4)).toThrowError(
			"Ship is out of bounds"
		);
	});
	...
	test("ship overlap", () => {
		expect(() =>
			player1.board.placeShip(player1.ships[3], 0, 2, "vertical")
		...
		expect(() =>
			player1.board.placeShip(player1.ships[3], 0, 1, "vertical")
		).toThrowError("There is already a ship placed here");
	});
	...
	test("previously placed ship", () => {
		...
		expect(() =>
			player1.board.placeShip(player1.ships[1], 0, 0, "vertical")
		).toThrowError("This ship has already been placed");
		expect(() =>
			player1.board.placeShip(player1.ships[2], 0, 0, "vertical")
		).toThrowError("This ship has already been placed");
	});

	test("attack out of bounds", () => {
		const player2 = new Player("Player", [5, 4, 3, 3, 2]);
		expect(() => player1.attack(10, 0, player2.board)).toThrowError(
			"Attack is out of bounds"
		);
		expect(() => player1.attack(-1, 0, player2.board)).toThrowError(
			"Attack is out of bounds"
		);
		expect(() => player1.attack(0, 10, player2.board)).toThrowError(
			"Attack is out of bounds"
		);
		expect(() => player1.attack(0, -1, player2.board)).toThrowError(
			"Attack is out of bounds"
		);
	});
});
